...
#define DEFAULT_MIBS "SNMPv2-MIB:RFC1213-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IF-MIB:IP-MIB:UCD-SNMP-MIB:UCD-DEMO-MIB:DISMAN-EVENT-MIB:IPV6-ICMP-MIB:IPV6-MIB:IPV6-TCP-MIB:IPV6-UDP-MIB:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:NET-SNMP-EXTEND-MIB:UCD-DLMOD-MIB:SNMP-NOTIFICATION-MIB:SNMP-TARGET-MIB:SNMPv2-TM"

/* default location to look for mibs to load using the above tokens
   and/or those in the MIBS envrionment variable*/
#define DEFAULT_MIBDIRS "/etc/snmp/mibs:/etc/config/snmp/mibs"
...
#define PERSISTENT_DIRECTORY "/var/run/snmpd"
...
#define SNMPCONFPATH "/etc/config/snmp"
...
#define SYS_CONTACT "Unspecified (Edit /etc/config/snmpd.conf)"

/* system location */
#define SYS_LOC "Unspecified (Edit /etc/config/snmpd.conf)"
...
#define ENTERPRISE_OID 25049
#define ENTERPRISE_MIB 1,3,6,1,4,1,25049
#define ENTERPRISE_DOT_MIB 1.3.6.1.4.1.25049
#define ENTERPRISE_DOT_MIB_LENGTH	7

/* The assigned enterprise number for sysObjectID. */
#define SYSTEM_MIB 1,3,6,1,4,1,25049,1,80
#define SYSTEM_DOT_MIB 1.3.6.1.4.1.25049.1.80
...
#define CONFIGURE_OPTIONS "'--host=arm-linux' '--build=i686-pc-linux-gnu' '--target=arm-linux' '--disable-static' '--enable-shared' '--with-enterprise-oid=25049' '--with-enterprise-sysoid=.1.3.6.1.4.1.25049.1.80' '--bindir=/bin' '--sbindir=/sbin' '--libdir=/lib' '--sysconfdir=/etc/config' '--with-endianness=little' '--with-default-snmp-version=3' '--with-sys-contact=Unspecified (Edit /etc/config/snmpd.conf)' '--with-sys-location=Unspecified (Edit /etc/config/snmpd.conf)' '--with-logfile=/var/log/snmpd.log' '--without-rpm' '--without-kmem-usage' '--with-mibdirs=/etc/snmp/mibs:/etc/config/snmp/mibs' '--with-persistent-directory=/var/run/snmpd' '--enable-mini-agent' '--enable-agentx-dom-sock-only' '--enable-applications' '--enable-privacy' '--enable-des' '--enable-ipv6' '--enable-md5' '--disable-manuals' '--disable-scripts' '--disable-set-support' '--disable-debugging' '--with-transports=UDPIPv6 TCPIPv6' '--with-out-transports=AAL5PVC IPX' '--with-mib-modules=ip-mib/ipv4InterfaceTable ip-mib/ipv6InterfaceTable  mibII/ip mibII/icmp mibII/tcp mibII/udp mibII/system_mib  mibII/ipAddr mibII/tcpTable mibII/udpTable if-mib if-mib/ifTable if-mib/ifXTable ip-mib smux agentx host/hr_system ucd_snmp disman/event notification   ucd-snmp/proxy' 'CC=ucfront-gcc arm-linux-gnueabi-20140823-gcc -march=armv4t -marm -mtune=arm922t -mno-thumb-interwork -msoft-float -mabi=aapcs-linux -mfloat-abi=soft -O1 -pipe -fno-common -fno-builtin -Wall  -Dlinux -D__linux__ -Dunix  -DEMBED -DOPENGEAR_ONLY_SEND_ONE_COLDSTART=1' 'CFLAGS=-O1 -pipe -fno-common -fno-builtin -Wall  -Dlinux -D__linux__ -Dunix  -DEMBED -DOPENGEAR_ONLY_SEND_ONE_COLDSTART=1' 'LDFLAGS=-Wl,-S -fno-common -fno-builtin' 'build_alias=i686-pc-linux-gnu' 'host_alias=arm-linux' 'target_alias=arm-linux'"
