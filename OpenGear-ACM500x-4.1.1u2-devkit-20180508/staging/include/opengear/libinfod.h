...
/* multiple push functions - from longer running processes, like emd, upsd, portmanager, alertd */
...
/* infod subscription functions */
int infod_subscribe(const char *subscr_name, const char *subscr_prefix, int *fd);
int infod_subscribe_add(int fd, const char *subscr_prefix);
int infod_subscribe_remove(int fd, const char *subscr_prefix);
