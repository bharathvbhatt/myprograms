...
public:
  ...
  istream_iterator() : _M_stream(0), _M_ok(false), _M_read_done(true), _M_value() {}
  istream_iterator(istream_type& __s) : _M_stream(&__s), _M_ok(false), _M_read_done(false), _M_value() {}
