...
# Automake Libraries
#
# CONFIG_LIB_LIBSSH2 is not set

#
# OpenGear Apps
#
CONFIG_PROP_CGI_RECOVERY=y
...
# CONFIG_PROP_SDT_SDT is not set
...
# CONFIG_PROP_NAGIOS is not set
# CONFIG_PROP_IFPROBE is not set
# CONFIG_PROP_UDPGW_UDPGW is not set
# CONFIG_PROP_DEVLOG_DEVLOG is not set
# CONFIG_PROP_EMD_EMD is not set
# CONFIG_PROP_BAYTECH_BAYTECH is not set
...
# CONFIG_USER_SREDIRD_SREDIRD is not set
...
# CONFIG_USER_NETSNMP_APPS_GET is not set
# CONFIG_USER_NETSNMP_APPS_GETNEXT is not set
# CONFIG_USER_NETSNMP_APPS_SET is not set
...
# CONFIG_USER_NETSNMP_APPS_TRAP is not set
# CONFIG_USER_NETSNMP_APPS_TRAPD is not set
# CONFIG_USER_NETSNMP_APPS_USM is not set
# CONFIG_USER_NETSNMP_APPS_VACM is not set
# CONFIG_USER_NETSNMP_APPS_WALK is not set
...
# CONFIG_USER_NETSNMP_AGENT_SNMPD is not set
...
# CONFIG_USER_POWERMAN_POWERMAN is not set
