...
# Devmon Config
#
CONFIG_PROP_DEVMON=y
CONFIG_PROP_DEVMON_AUTODETECT=y
CONFIG_PROP_DEVMON_YASDISHELL=y
CONFIG_PROP_DEVMON_AURORA=y
CONFIG_PROP_DEVMON_SUNGROW=y
# CONFIG_PROP_DEVMON_WWSR is not set
CONFIG_PROP_DEVMON_CALLHOME=y
CONFIG_PROP_DEVMON_INGENERO_PORTAL=y
CONFIG_PROP_DEVMON_INGENERO_DEFAULTS=y
CONFIG_PROP_DEVMON_TIMEZONE_PORTAL=y
# CONFIG_PROP_DEVMON_SPOTTYGUM_PORTAL is not set
# CONFIG_PROP_DEVMON_PVOUTPUT_PORTAL is not set
# CONFIG_PROP_DEVMON_PACHUBE_PORTAL is not set
# CONFIG_PROP_DEVMON_THINGSPEAK_PORTAL is not set
CONFIG_PROP_DEVMON_EMD_DRIVER=y
CONFIG_PROP_DEVMON_SUNGROW_DRIVER=y
CONFIG_PROP_DEVMON_POWERONE_DRIVER=y
...
# CONFIG_USER_MTOOLS_MTOOLS is not set
...
# CONFIG_USER_NUT_WITH_OTHERS is not set
...
CONFIG_USER_OPENNTPD_OPENNTPD=y
...
CONFIG_USER_BUSYBOX_FEATURE_TRACEROUTE_VERBOSE=y
CONFIG_USER_BUSYBOX_FEATURE_TRACEROUTE_SOURCE_ROUTE=y
CONFIG_USER_BUSYBOX_FEATURE_TRACEROUTE_USE_ICMP=y
...
CONFIG_USER_BUSYBOX_FEATURE_TOP_DECIMALS=y
...
# CONFIG_USER_IFMETRIC is not set
