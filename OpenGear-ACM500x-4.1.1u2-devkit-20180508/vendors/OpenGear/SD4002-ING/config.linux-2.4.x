...
# CONFIG_MACH_SD4002DX is not set
# CONFIG_MACH_SD4001DW is not set
...
# CONFIG_MTD_SNAPARM_BANK is not set
# CONFIG_MTD_SNAPARM_ALT is not set
...
CONFIG_SERIAL=y
CONFIG_SERIAL_CONSOLE=y
CONFIG_SERIAL_OG_RS4xx=y
CONFIG_SNX_MULTIIO_M=y
CONFIG_SNX_MULTIIO_M=y
# CONFIG_SNX_MULTIIO is not set
