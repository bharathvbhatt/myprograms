...
# CONFIG_LIB_UCLIBCXX is not set
...
# CONFIG_PROP_PORTMANAGER_PMDUMPD is not set
# CONFIG_PROP_PORTMANAGER_PMHOSTS is not set
...
CONFIG_PROP_NODE_COMMAND=y
CONFIG_PROP_IFPROBE=y
...
CONFIG_PROP_MONITOR_MONITOR=y
CONFIG_PROP_OPENGEAR_SERIAL_CLIENT=y
...
# CONFIG_USER_CURL_LIBCURL is not set
...
CONFIG_USER_TCPWRAP_TCPD=y
# CONFIG_USER_TCPWRAP_MISCD is not set
# CONFIG_USER_TCPWRAP_FINGER is not set
# CONFIG_USER_TCPWRAP_TCPDMATCH is not set
# CONFIG_USER_TCPWRAP_TRYFROM is not set
# CONFIG_USER_TCPWRAP_TCPDCHK is not set
...
# CONFIG_USER_NAGIOS_PLUGINS is not set
CONFIG_USER_NRPE=y
CONFIG_USER_NSCA=y
...
# CONFIG_USER_BUSYBOX_FEATURE_SU_SYSLOG is not set
# CONFIG_USER_BUSYBOX_FEATURE_SU_CHECKS_SHELLS is not set
