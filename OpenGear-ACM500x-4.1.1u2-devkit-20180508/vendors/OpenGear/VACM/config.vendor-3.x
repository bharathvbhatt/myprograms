...
CONFIG_LIB_LIBSSL=y
# CONFIG_LIB_OPENSSL_FIPS is not set
CONFIG_LIB_LIBGMP=y
...
# CONFIG_PROP_DEVLOG_DEVLOG is not set
...
# CONFIG_PROP_CELLCTL_CELLCTL is not set
# CONFIG_PROP_SMSD is not set
...
# CONFIG_USER_TRACEROUTE is not set
