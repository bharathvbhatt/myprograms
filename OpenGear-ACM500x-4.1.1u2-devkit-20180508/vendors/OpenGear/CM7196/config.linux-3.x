...
CONFIG_MTD_NAND_ARMADA=y
CONFIG_MTD_NAND_ARMADA_GANG_SUPPORT=y
CONFIG_MTD_NAND_ARMADA_MLC_SUPPORT=y
CONFIG_MTD_NAND_ARMADA_INIT_RESET=y
# CONFIG_MTD_NAND_ARMADA_NEGLECT_RNB is not set
CONFIG_MTD_NAND_ARMADA_SOFT_BCH=y
...
# CONFIG_EXAR_GPIO_SUPPORT is not set
