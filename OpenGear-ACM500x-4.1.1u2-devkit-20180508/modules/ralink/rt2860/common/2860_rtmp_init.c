...
PNDIS_PACKET RTMPAllocateRxPacketBuffer(
	IN	PRTMP_ADAPTER			pAd,
	IN	UINT					Index,
	IN	PRTMP_DMABUF			pDmaBuf,
	IN	BOOLEAN					Cached)
{
	return RTMP_AllocateRxPacketBuffer(
				pAd,
				pDmaBuf->AllocSize,
				Cached,
				&pDmaBuf->AllocVa,
...
#ifdef SPECIFIC_MEM_MGMT
			pPacket = RTMPAllocateRxPacketBuffer(pAd, index, pDmaBuf, FALSE);
