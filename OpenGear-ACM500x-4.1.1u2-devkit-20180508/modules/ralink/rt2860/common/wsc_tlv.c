	...
	OUT	PWSC_REG_DATA pReg)
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M1_RECEIVED;	
...
#else
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M2_RECEIVED;	
	...
	OUT	PWSC_REG_DATA pReg)
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M2D_RECEIVED;
	...
	OUT	PWSC_REG_DATA pReg)
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M3_RECEIVED;	
	...
	OUT	PWSC_REG_DATA pReg)
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M4_RECEIVED;	
	if( FieldCheck[0] || FieldCheck[1] || FieldCheck[2] || FieldCheck[3] || FieldCheck[4] || FieldCheck[5] || FieldCheck[6] )
		ret = WSC_ERROR_WANTING_FIELD;
out :
	if(NULL != IV_DecrData)
	...
	OUT	PWSC_REG_DATA pReg)
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M5_RECEIVED;
	...
	OUT	PWSC_REG_DATA pReg)
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M6_RECEIVED;	
	...
	OUT	PWSC_REG_DATA pReg)
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M7_RECEIVED;	
	...
	IN  PWSC_CTRL       pWscControl)
{
	...
	// Update WSC status
	pAdapter->StaCfg.WscControl.WscStatus = STATUS_WSC_EAP_M8_RECEIVED;	
