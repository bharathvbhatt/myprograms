...
/* SEPXXAN registers */
/* The shift to view port i vs i+1 (1,2 3,4) */
#define PORT_SHIFT 	16
#define SEP_AN_LP_10HALF 		(1 << 0)
#define SEP_AN_LP_10FULL		(1 << 1)
#define SEP_AN_LP_100HALF 		(1 << 2)
#define SEP_AN_LP_100FULL		(1 << 3)
#define SEP_AN_LP_FLOW 			(1 << 4)
#define SEP_AN_LINK_SPEED_STATUS	(1 << 5)
#define SEP_AN_LINK_DUPLEX_STATUS 	(1 << 6)
#define SEP_AN_LINK_STATUS 		(1 << 7)
#define SEP_AN_AD_10HALF 		(1 << 8)
#define SEP_AN_AD_10FULL		(1 << 9)
#define SEP_AN_AD_100HALF 		(1 << 10)
#define SEP_AN_AD_100FULL		(1 << 11)
#define SEP_AN_AD_FLOW 			(1 << 12)
#define SEP_AN_RESTART_AN		(1 << 13)
#define SEP_AN_AD_DONE			(1 << 14)
