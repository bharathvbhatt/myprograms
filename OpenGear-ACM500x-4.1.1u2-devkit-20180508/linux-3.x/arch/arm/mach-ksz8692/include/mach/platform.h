...
#define	KS8692_WRITE_REG(offset, v)	__raw_writel((v), ((volatile void *)KS8692_VA_IO_BASE + (offset)))
#define	KS8692_READ_REG(offset)		__raw_readl(((volatile void *)KS8692_VA_IO_BASE + (offset)))
