...
#ifndef __ASM_ARCH_LPC28XX_H
#define __ASM_ARCH_LPC28XX_H
...
#define UART_MCR   (*((volatile unsigned int *) 0x80011010))
...
/* USB */
#define USB_BASE_ADDR		0x80041000
