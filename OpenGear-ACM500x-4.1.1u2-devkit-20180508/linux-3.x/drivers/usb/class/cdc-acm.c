...
// OG: Some Cisco USB consoles (validated on ISR 2921 Gen 2) seem to need baud
// rate changes sent through multiple times. Always send the line change
// messages
