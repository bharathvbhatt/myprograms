...
static int __init armada_370_pinctrl_drv_register(void)
{
	return platform_driver_register(&armada_370_pinctrl_driver);
}
postcore_initcall(armada_370_pinctrl_drv_register);

static void __exit armada_370_pinctrl_drv_unregister(void)
{
	platform_driver_unregister(&armada_370_pinctrl_driver);
}
module_exit(armada_370_pinctrl_drv_unregister);
