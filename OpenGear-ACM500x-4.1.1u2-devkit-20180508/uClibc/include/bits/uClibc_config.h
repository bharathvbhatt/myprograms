...
#define __KERNEL_HEADERS__ "$(STAGEDIR)/include"
...
#define __UCLIBC_PWD_BUFFER_SIZE__ 4096
#define __UCLIBC_GRP_BUFFER_SIZE__ 4096
...
#undef __UCLIBC_ICONV_NOLOCALE_HACK__
...
#define __UCLIBC_EXTRA_CFLAGS__ "$(CPUFLAGS)"
#undef __DODEBUG__
#undef __DOSTRIP__
#undef __DOASSERTS__
