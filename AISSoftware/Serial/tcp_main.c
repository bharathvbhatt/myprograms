...
void init_tcp()
{
	...
	server_init();  /*Initialise the server side code*/
...
void server_send( char buff[])
{
...

	{
		...
		fp = open("/home/pi/myhome/index.html",O_RDONLY);
		if(fp<0)
		{
	...
	else if(strstr(buff,"GET /styles.ff4089ceb584020db346.css HTTP/1.1")!=NULL)
	{
		...
		fp = open("/home/pi/myhome/styles.ff4089ceb584020db346.css",O_RDONLY);
		if(fp<0)
		{
			printf("Error file cant be opened!\n");
		}
	...
	else if(strstr(buff,"GET /runtime.2f29e12616932f0ed037.js HTTP/1.1")!=NULL)
	{
		...
		fp = open("/home/pi/myhome/runtime.2f29e12616932f0ed037.js",O_RDONLY);
		if(fp<0)
		{
			printf("Error file cant be opened!\n");
		}
	...
	else if(strstr(buff,"GET /polyfills.d480d2ebf3b3121ca487.js HTTP/1.1")!=NULL)
	{
		...
		strcat(header,"HTTP/1.1 200 OK\nContent-Type: application/javascript;charset=utf-8");
		fp = open("/home/pi/myhome/polyfills.d480d2ebf3b3121ca487.js",O_RDONLY);
		if(fp<0)
		{
			printf("Error file cant be opened!\n");
		}
	...
	else if(strstr(buff,"GET /main.b72a0f7abd963372e58d.js HTTP/1.1")!=NULL)
	{
		...
		strcat(header,"HTTP/1.1 200 OK\nContent-Type: application/javascript;charset=utf-8");
		fp = open("/home/pi/myhome/main.b72a0f7abd963372e58d.js",O_RDONLY);
		if(fp<0)
		{
			printf("Error file cant be opened!\n");
		}
	...
	else if(strstr(buff,"GET /vendor.js HTTP/1.1")!=NULL)
		{
			...
			strcat(header,"HTTP/1.1 200 OK\nContent-Type: application/javascript;charset=utf-8");
			fp = open("/home/pi/myhome/vendor.js",O_RDONLY);
			if(fp<0)
			{
				printf("Error file cant be opened!\n");
			}
	...
	else if(strstr(buff,"GET /layers-2x.4f0283c6ce28e888000e.png HTTP/1.1")!=NULL)
	{
		...
		fp = open("/home/pi/myhome/favicon.ico",O_RDONLY);
		if(fp<0)
		{
			printf("Error file cant be opened!\n");
		}
	...
	else if(strstr(buff,"GET /data.txt HTTP/1.1")!=NULL)
	{
		printf("Getting data text\n");
		file_get();
		strcat(header,"HTTP/1.1 200 OK\nContent-Type: text");
		fp = open("/home/pi/myhome/AIS_data.txt",O_RDONLY);
		if(fp<0)
		{
			printf("Error file cant be opened!\n");
		}
...
/*.............*/
	else if(strstr(buff,"GET /assets/logo-vesseltracker.png HTTP/1.1")!=NULL)
		{
			printf("Getting data text\n");
			file_get();
			strcat(header,"HTTP/1.1 200 OK\nContent-Type: image/x-icon");
			fp = open("/home/pi/myhome/logo-vesseltracker.png",O_RDONLY);
			if(fp<0)
			{
				printf("Error file cant be opened!\n");
			}
	...
	else if(strstr(buff,"GET /assets/but-i-selected.png HTTP/1.1")!=NULL)
		{
			printf("Getting data text\n");
			file_get();
			strcat(header,"HTTP/1.1 200 OK\nContent-Type: image/x-icon");
			fp = open("/home/pi/myhome/but-i-selected.png",O_RDONLY);
			if(fp<0)
			{
				printf("Error file cant be opened!\n");
			}
	...
	else if(strstr(buff,"GET /assets/but-i.png HTTP/1.1")!=NULL)
		{
			printf("Getting data text\n");
			file_get();
			strcat(header,"HTTP/1.1 200 OK\nContent-Type: image/x-icon");
			fp = open("/home/pi/myhome/but-i.png",O_RDONLY);
			if(fp<0)
			{
				printf("Error file cant be opened!\n");
			}
	...
	else if(strstr(buff,"GET /assets/but-selected.png HTTP/1.1")!=NULL)
		{
			printf("Getting data text\n");
			file_get();
			strcat(header,"HTTP/1.1 200 OK\nContent-Type: image/x-icon");
			fp = open("/home/pi/myhome/but-selected.png",O_RDONLY);
			if(fp<0)
			{
				printf("Error file cant be opened!\n");
			}
	...
	else if(strstr(buff,"GET /assets/flag-denmark.png HTTP/1.1")!=NULL)
		{
			printf("Getting data text\n");
			file_get();
			strcat(header,"HTTP/1.1 200 OK\nContent-Type: image/x-icon");
			fp = open("/home/pi/myhome/flag-denmark.png",O_RDONLY);
			if(fp<0)
			{
				printf("Error file cant be opened!\n");
			}
	...
	else if(strstr(buff,"GET /assets/flag-uk.png HTTP/1.1")!=NULL)
		{
			printf("Getting data text\n");
			file_get();
			strcat(header,"HTTP/1.1 200 OK\nContent-Type: image/x-icon");
			fp = open("/home/pi/myhome/flag-uk.png",O_RDONLY);
			if(fp<0)
			{
				printf("Error file cant be opened!\n");
			}
	...
	else if(strstr(buff," GET /assets/sidebut-about.png HTTP/1.1")!=NULL)
		{
			printf("Getting data text\n");
			file_get();
			strcat(header,"HTTP/1.1 200 OK\nContent-Type:image/x-icon ");
			fp = open("/home/pi/myhome/sidebut-about.png",O_RDONLY);
			if(fp<0)
			{
				printf("Error file cant be opened!\n");
			}
	...
	else if(strstr(buff," GET /assets/sidebut-selected.png HTTP/1.1")!=NULL)
			{
				printf("Getting data text\n");
				file_get();
				strcat(header,"HTTP/1.1 200 OK\nContent-Type:image/x-icon ");
				fp = open("/home/pi/myhome/sidebut-selected.png",O_RDONLY);
				if(fp<0)
				{
					printf("Error file cant be opened!\n");
				}
	...
	else if(strstr(buff," GET /assets/sidebut.png HTTP/1.1")!=NULL)
			{
				printf("Getting data text\n");
				file_get();
				strcat(header,"HTTP/1.1 200 OK\nContent-Type:image/x-icon ");
				fp = open("/home/pi/myhome/sidebut.png",O_RDONLY);
				if(fp<0)
				{
					printf("Error file cant be opened!\n");
				}
